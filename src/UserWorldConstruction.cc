#include "UserWorldConstruction.hh"

#define SIZE(x) (size_t)(sizeof(x)/sizeof(*x))

UserWorldConstruction::UserWorldConstruction() : WorldConstruction()
{

}

UserWorldConstruction::~UserWorldConstruction() 
{

}

void UserWorldConstruction::BuildGeometry() 
{   
...
MaterialProperties* UserWorldConstruction::BuildProperties(const TString& name)
{
	...
	if(name == "Lu1.6Y0.4SiO5")
	{
	    ...
	    std::pair<TString, Double_t> nonrad_tau_2F7sl2[] = {{"2F5/2", 1.0 * unit_ps}};
	    shell* up2F7sl2 = new shell("2F7/2", 0.25 * unit_eV, nullptr, 0, nonrad_tau_2F7sl2, 1);
	    std::tuple<TString, Double_t, LinearInterpolation*> rad_tau_5d1[] = {{"2F7/2", 80.0 * unit_ns, LinearInterpolation::Initialization(folder + TString("/single_line.txt"), unit_eV, 1.0)}, 
		                                                                     {"2F5/2", 80.0 * unit_ns, LinearInterpolation::Initialization(folder + TString("/single_line.txt"), unit_eV, 1.0)}};
	    std::pair<TString, Double_t> nonrad_tau_5d1[] = {{"2F7/2", 100.0 * unit_ns}};
	    ...
	    Double_t Ce3p_crate_of_ex_to_5d1_rate[] = {1.0 / unit_ps, 1.0 / unit_ps};
	    ...
	    std::pair<TString, Double_t> nonrad_tau_etrap_level_2[] = {{"level_1", 1.0 * unit_ps}};
	    ...
	    Double_t etrap_crate_of_e_to_level_2_rate[] = {1.0 / unit_ps, 1.0 / unit_ps};
	    ...
	    std::pair<TString, Double_t> nonrad_tau_htrap_level_2[] = {{"level_1", 1.0 * unit_ps}};
	    ...
	    Double_t htrap_crate_of_h_to_level_2_rate[] = {1.0 / unit_ps, 1.0 / unit_ps};
